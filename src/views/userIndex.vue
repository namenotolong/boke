    ...
    <div class="content">
      <div :class="{user_content : true, is_top : top_temp}">
        <div class="user-info user-data-base">
          <el-button round type="success" onclick="javascript:window.location.href='/index'">返回</el-button>
          ...
          <el-button type="danger" icon="el-icon-star-off" circle style="margin-left: 0%" v-else @click="cancelFollow">已关注</el-button>
        </div>
        ...
        <div class="user-data-base user-all-articles">
          <h3 style="margin-top: 5%" class="title-mid">最新文章</h3>
